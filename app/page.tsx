...
const LandingPage: FC = () => {
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 w-full py-12 md:py-16">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={index} className="flex items-start gap-3">
                  ...
                  <span className="text-base md:text-lg font-medium text-black">{benefit}</span>
                </li>
              ))}
            </ul>
      ...
      {/* Feature Grid */}
      <section className="bg-[#FFF5F2] w-full border-y border-[#FFE7E0] py-8 md:py-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8">
            {[
              ...
              <div key={index} className="space-y-6">
                <div className="p-3 bg-white rounded-xl w-fit shadow-sm border border-gray-100">
                  <Image
                    src={feature.icon}
                    alt={feature.title}
                    width={24}
                ...
                <div className="space-y-2">
                  <p className="text-xs text-gray-400 font-medium uppercase tracking-wider">{feature.desc}</p>
