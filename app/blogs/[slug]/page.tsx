...
//     <Image
//       src={(post as any).jetpack_featured_media_url}
...
//     />
//   </div>
// ) : featuredImage?.source_url && !featuredImage.code ? (
//   <div className="mb-8 aspect-video relative overflow-hidden rounded-xl border-2 border-black shadow-[6px_6px_0px_0px_rgba(128,128,128,1)]">
//     <Image
...
import parse from 'html-react-parser';
import BlogCard from '@/components/blog/BlogCard';
import FeaturedImage from '@/components/blog/FeaturedImage'; // Import the new component
...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  return (
    <article className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      {/* Featured Image - Using the new client component
      <FeaturedImage 
        src={(post as any).jetpack_featured_media_url || (featuredImage?.source_url && !featuredImage.code ? featuredImage.source_url : null)}
        alt={featuredImage?.alt_text || post.title.rendered}
        priority={true}
      /> */}
